...
* Parameters
  ...
  + *beta*: site-level effect of water availability (log volumetric yield at Big G) on little g (slope)
  + *alpha.mu*: global intercept
  + *beta.mu*: global effect of water availability (log volumetric yield at Big G) on little g (slope)
  + *alpha.sig.site*: site-level variability in the intercept
  + *beta.sig.site*: site-level variability in the slope
  + *sigma*: process error 
...
* Parameters
  ...
  + *alpha.sig.site*: site-level variability in the intercept
  + *beta.sig.site*: site-level variability in the slope
  + *alpha.sig*: process error intercept
