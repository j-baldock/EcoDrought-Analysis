...
***Question***: How does water availability affect *upstream* diversity in streamflow regimes? How does this manifest as heterogeneity ***within*** and ***among*** locations in the upstream river network?
...
```{r}
MCMCtrace(mod_0, ind = TRUE, params = c("alpha.mu", "beta.mu", "alpha.sigma", "beta.sigma", "sig.alpha.mu", "sig.beta.mu", "sig.alpha.sigma", "sig.beta.sigma"), pdf = FALSE)
```
...
# plot
sitib %>% ggplot(aes(x = slopes, y = intercepts, color = site_name)) + geom_point() + theme_bw()
