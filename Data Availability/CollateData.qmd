...
Check approval for key sites: Sub-daily
::: panel-tabset
#### West Brook
```{r, echo=FALSE}
...
Check approval for key sites: Daily
::: panel-tabset
#### South River Conway (West Brook)
```{r, echo=FALSE}
nwis_daily %>% filter(site_name == "South River Conway NWIS") %>% select(date, flowcfs, flowcfs_appcd) %>% spread(key = flowcfs_appcd, value = flowcfs) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "flow (cfs)")%>% dyOptions(drawGrid = FALSE, axisLineWidth = 1.5, fillGraph = TRUE)
```
#### Donner Blitzen (DB)
```{r, echo=FALSE}
nwis_daily %>% filter(site_name == "Donner Blitzen River nr Frenchglen NWIS") %>% select(date, flowcfs, flowcfs_appcd) %>% spread(key = flowcfs_appcd, value = flowcfs) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "flow (cfs)")%>% dyOptions(drawGrid = FALSE, axisLineWidth = 1.5, fillGraph = TRUE)
```
#### NF Flathead (Big, Coal, McGee)
```{r, echo=FALSE}
nwis_daily %>% filter(site_name == "North Fork Flathead River NWIS") %>% select(date, flowcfs, flowcfs_appcd) %>% spread(key = flowcfs_appcd, value = flowcfs) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "flow (cfs)")%>% dyOptions(drawGrid = FALSE, axisLineWidth = 1.5, fillGraph = TRUE)
```
#### Pacific Creek (Snake)
```{r, echo=FALSE}
nwis_daily %>% filter(site_name == "Pacific Creek at Moran NWIS") %>% select(date, flowcfs, flowcfs_appcd) %>% spread(key = flowcfs_appcd, value = flowcfs) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "flow (cfs)")%>% dyOptions(drawGrid = FALSE, axisLineWidth = 1.5, fillGraph = TRUE)
```
#### Yellowstone (Shields/Duck)
```{r, echo=FALSE}
nwis_daily %>% filter(site_name == "Yellowstone River Livingston NWIS") %>% select(date, flowcfs, flowcfs_appcd) %>% spread(key = flowcfs_appcd, value = flowcfs) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "flow (cfs)")%>% dyOptions(drawGrid = FALSE, axisLineWidth = 1.5, fillGraph = TRUE)
```
#### Rapidan River (Staunton)
```{r, echo=FALSE}
nwis_daily %>% filter(site_name == "Rapidan River NWIS") %>% select(date, flowcfs, flowcfs_appcd) %>% spread(key = flowcfs_appcd, value = flowcfs) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "flow (cfs)")%>% dyOptions(drawGrid = FALSE, axisLineWidth = 1.5, fillGraph = TRUE)
```
#### Battle Run (Piney)
```{r, echo=FALSE}
nwis_daily %>% filter(site_name == "Battle Run NWIS") %>% select(date, flowcfs, flowcfs_appcd) %>% spread(key = flowcfs_appcd, value = flowcfs) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "flow (cfs)")%>% dyOptions(drawGrid = FALSE, axisLineWidth = 1.5, fillGraph = TRUE)
```
#### South River (Paine)
```{r, echo=FALSE}
nwis_daily %>% filter(site_name == "South River Harriston NWIS") %>% select(date, flowcfs, flowcfs_appcd) %>% spread(key = flowcfs_appcd, value = flowcfs) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "flow (cfs)")%>% dyOptions(drawGrid = FALSE, axisLineWidth = 1.5, fillGraph = TRUE)
```
:::
...
```{r, fig.height=8, fig.width=10}
#| fig-cap: "Daily mean stream flow (cfs) for Big/Super G NWIS gages"
...
#### Big Creek
```{r, echo=FALSE}
dat_daily_fill_wyield %>% filter(designation %in% c("little", "medium"), subbasin == "Big Creek") %>% select(date, site_name, tempc_mean) %>% spread(key = site_name, value = tempc_mean) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "Daily mean temperature (deg. C)")
```
#### Coal Creek
```{r, echo=FALSE}
dat_daily_fill_wyield %>% filter(designation %in% c("little", "medium"), subbasin == "Coal Creek")  %>% select(date, site_name, tempc_mean) %>% spread(key = site_name, value = tempc_mean) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "Daily mean temperature (deg. C)")
```
#### McGee Creek
```{r, echo=FALSE}
dat_daily_fill_wyield %>% filter(designation %in% c("little", "medium"), subbasin == "McGee Creek")  %>% select(date, site_name, tempc_mean) %>% spread(key = site_name, value = tempc_mean) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "Daily mean temperature (deg. C)")
```
#### West Brook
```{r, echo=FALSE}
dat_daily_fill_wyield %>% filter(designation %in% c("little", "medium"), subbasin == "West Brook") %>% select(date, site_name, tempc_mean) %>% spread(key = site_name, value = tempc_mean) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "Daily mean temperature (deg. C)")
```
#### Paine Run
```{r, echo=FALSE}
dat_daily_fill_wyield %>% filter(designation %in% c("little", "medium"), subbasin == "Paine Run") %>% select(date, site_name, tempc_mean) %>% spread(key = site_name, value = tempc_mean) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "Daily mean temperature (deg. C)")
```
#### Staunton River
```{r, echo=FALSE}
dat_daily_fill_wyield %>% filter(designation %in% c("little", "medium"), subbasin == "Staunton River") %>% select(date, site_name, tempc_mean) %>% spread(key = site_name, value = tempc_mean) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "Daily mean temperature (deg. C)")
```
#### Duck Creek
```{r, echo=FALSE}
dat_daily_fill_wyield %>% filter(designation %in% c("little", "medium"), subbasin == "Duck Creek") %>% select(date, site_name, tempc_mean) %>% spread(key = site_name, value = tempc_mean) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "Daily mean temperature (deg. C)")
```
#### Shields River
```{r, echo=FALSE}
dat_daily_fill_wyield %>% filter(designation %in% c("little", "medium"), subbasin == "Shields River") %>% select(date, site_name, tempc_mean) %>% spread(key = site_name, value = tempc_mean) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "Daily mean temperature (deg. C)")
```
#### Snake River
```{r, echo=FALSE}
dat_daily_fill_wyield %>% filter(designation %in% c("little", "medium"), subbasin == "Snake River") %>% select(date, site_name, tempc_mean) %>% spread(key = site_name, value = tempc_mean) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "Daily mean temperature (deg. C)")
```
#### Donner Blitzen
```{r, echo=FALSE}
dat_daily_fill_wyield %>% filter(designation %in% c("little", "medium"), subbasin == "Donner Blitzen") %>% select(date, site_name, tempc_mean) %>% spread(key = site_name, value = tempc_mean) %>% dygraph() %>% dyRangeSelector() %>% dyAxis("y", label = "Daily mean temperature (deg. C)")
```
:::
