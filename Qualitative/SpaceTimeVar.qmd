...
Test pit
```{r}
portfolioplot(bas = "West Brook", orderr = wborder, type = "scatter", wtryrs = c(2018:2024))
portfolioplot(bas = "West Brook", orderr = wborder, type = "annual", wtryrs = c(2018:2024))
```
...
ggarrange(plotlist = plotlist, common.legend = TRUE, legend = "right")
```
...
ggarrange(plotlist = plotlist, common.legend = TRUE, legend = "right", nrow = 2, ncol = 4)
```
...
jpeg("C:/Users/jbaldock/OneDrive - DOI/Documents/USGS/EcoDrought/EcoDrought Working/EcoDrought-Analysis/Qualitative/TESTMAP.jpg", width = 10, height = 7, units = "in", res = 1000)
ggarrange(plotlist = plotlist, common.legend = TRUE, legend = "right")
dev.off()
```
