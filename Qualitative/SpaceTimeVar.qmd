...
```{r}
portfolioplot <- function(bas, orderr, type = c("interann", "annual", "scatter")) {
  # filter data
  tempdat <- dat_clean %>% 
  ...
  summerflow <- tempdat_big %>% group_by(WaterYear) %>% summarize(totalyield = sum(Yield_mm), totalyield_log = log(sum(Yield_mm))) %>% ungroup()
  ...
  ppew <- pedat %>% 
    ggplot(aes(x = totalyield_log, y = pe_range)) + 
    geom_smooth(method = "lm", color = "black") + 
    geom_point(shape = 1) +
    xlab("Total yield at reference gage (logged)") + ylab("Relative difference in range") +
...
```{r, include=FALSE}
# West Brook
p1 <- egg::ggarrange(portfolioplot(bas = "West Brook", orderr = wborder, type = "interannual"),
               portfolioplot(bas = "West Brook", orderr = wborder, type = "scatter"),
               nrow = 2)
p2 <- portfolioplot(bas = "West Brook", orderr = wborder, type = "annual")
denwb <- ggarrange(p1, p2, ncol = 2, widths = c(0.7,1))

# Paine
p1 <- egg::ggarrange(portfolioplot(bas = "Paine Run", orderr = paineorder, type = "interannual"),
               portfolioplot(bas = "Paine Run", orderr = paineorder, type = "scatter"),
               nrow = 2)
p2 <- portfolioplot(bas = "Paine Run", orderr = paineorder, type = "annual")
denpa <- ggarrange(p1, p2, ncol = 2, widths = c(0.7,1))

# Staunton
p1 <- egg::ggarrange(portfolioplot(bas = "Staunton River", orderr = stauntorder, type = "interannual"),
               portfolioplot(bas = "Staunton River", orderr = stauntorder, type = "scatter"),
               nrow = 2)
p2 <- portfolioplot(bas = "Staunton River", orderr = stauntorder, type = "annual")
denst <- ggarrange(p1, p2, ncol = 2, widths = c(0.7,1))

# Flathead
p1 <- egg::ggarrange(portfolioplot(bas = "Flathead", orderr = flatorder, type = "interannual"),
               portfolioplot(bas = "Flathead", orderr = flatorder, type = "scatter"),
               nrow = 2)
p2 <- portfolioplot(bas = "Flathead", orderr = flatorder, type = "annual")
denfl <- ggarrange(p1, p2, ncol = 2, widths = c(0.7,1))

# Yellowstone
p1 <- egg::ggarrange(portfolioplot(bas = "Shields River", orderr = yellorder, type = "interannual"),
               portfolioplot(bas = "Shields River", orderr = yellorder, type = "scatter"),
               nrow = 2)
p2 <- portfolioplot(bas = "Shields River", orderr = yellorder, type = "annual")
denye <- ggarrange(p1, p2, ncol = 2, widths = c(0.7,1))

# Snake River
p1 <- egg::ggarrange(portfolioplot(bas = "Snake River", orderr = snakeorder, type = "interannual"),
               portfolioplot(bas = "Snake River", orderr = snakeorder, type = "scatter"),
               nrow = 2)
p2 <- portfolioplot(bas = "Snake River", orderr = snakeorder, type = "annual")
densn <- ggarrange(p1, p2, ncol = 2, widths = c(0.7,1))

# Donner Blitzen
p1 <- egg::ggarrange(portfolioplot(bas = "Donner Blitzen", orderr = donnerorder, type = "interannual"),
               portfolioplot(bas = "Donner Blitzen", orderr = donnerorder, type = "scatter"),
               nrow = 2)
p2 <- portfolioplot(bas = "Donner Blitzen", orderr = donnerorder, type = "annual")
