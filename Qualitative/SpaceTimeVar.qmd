...
Interanntual summer log(yield) distributions for all basins
...
jpeg("C:/Users/jbaldock/OneDrive - DOI/Documents/USGS/EcoDrought/EcoDrought Working/Presentation figs/EcoD_RangeDiff_allsites_skinny.jpg", width = 4.5, height = 5, units = "in", res = 1000)
randiffplot
dev.off()
```
