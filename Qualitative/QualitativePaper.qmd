...
2. Evaluate the predictive ability of existing streamflow modeling techniques for use in headwater systems.
3. Explore what spatial heterogeneity in headwater streamflow regimes says about spatial variability in flow response to climatic/meteorological drivers (drought effects).
